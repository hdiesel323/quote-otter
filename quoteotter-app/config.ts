...
const config = {
  ...
  appDescription:
    "Get free quotes for home services, insurance, moving, legal, financial services and more. Compare prices from trusted professionals near you.",
  ...
  resend: {
    ...
    fromNoReply: `QuoteOtter <noreply@quoteotter.com>`,
    // REQUIRED — Email 'From' field to be used when sending other emails, like abandoned carts, updates etc..
    fromAdmin: `QuoteOtter Team <hello@quoteotter.com>`,
